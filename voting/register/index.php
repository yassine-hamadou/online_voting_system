                         ...
                         <form method = "post" enctype = "multipart/form-data">
                                ...
                                <div class="form-heading">
                         		<center>Voter Registeration</center>
											...
											<div class="form-field">
												<label>Program of Study <i>(enter initials only i.e Bcs, IT, Eng..)</i></label><br/>
													<input class="form-control"  type = "text" name = "prog_study" placeholder="E.g IT, Bcs,BFIN, BITED" required="true">
											</div>
                                            ...
                                            <div class="link">
											 	 <h2>
											 	 	<center>
											 	 		<a href="../login.php" style = "font-size:16px;">	Login to vote
											 	 		</a>
											 	 	</center>
											 	 </h2>
											</div>
