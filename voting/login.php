                ...
                <div class="form-panel">
                    ...
                    <form role="form" method="post" enctype="multipart/form-data" class="index-form">
                        ...
                        <div class="form-field">
                            ...
                            <input class="form-control" placeholder="Enter Student ID" name="idno" type="text"
                        ...
                        <br/>
                        <center>
                            <button class="btn btn-lg btn-success btn-block " name="login" style=" margin-bottom:0px;"
                                    width="50">Login
                            </button>
                            &nbsp;
                            <a href="register/index.php">
                                <button type="button" class="btn btn-lg btn-success btn-block" data-dismiss="modal"
                                        style=" margin-bottom:0px;">Register
                                </button>
                            </a>
